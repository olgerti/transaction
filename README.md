...
Project requires PHP 7.3 or above.

Simply go to project directory where the composer.json file is located and type in your terminal: 
composer install

Showing transactions for a customer id specified as a command line argument.
On project root directory type in your terminal: 
php scripts/report.php --customer_id={id}; 
